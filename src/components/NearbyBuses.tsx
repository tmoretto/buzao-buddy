  ...
  return (
    ...
    >
      ...
      >
        {/* Line badge */}
        <div
          className="font-signage-tight flex items-center justify-center rounded-lg font-bold text-base px-2 shrink-0"
          style={{
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <span className="font-signage-tight text-base font-medium truncate" style={{ color: "#E8ECEF" }}>
              {bus.destination}
            </span>
        ...
        <div className="flex flex-col items-end shrink-0">
          <div className="flex items-center gap-1">
            ...
            <span className="font-signage-tight text-base font-bold" style={{ color: "#00A651" }}>
              {bus.distance}m
            </span>
          </div>
          <span className="font-signage text-[12px]" style={{ color: "#6B7D8E" }}>de você</span>
        </div>
      </div>
    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: "#0F1419" }}>
      ...
      <div className="shrink-0" style={{ height: "45%" }}>
        {hasGps ? (
          ...
          >
            <p className="text-base" style={{ color: "#6B7D8E" }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4 flex flex-col gap-2">
        {error ? (
          <div className="flex flex-col items-center justify-center py-8 gap-3 text-center">
            ...
            <p className="text-base font-medium" style={{ color: "#E8ECEF" }}>
          ...
          <div className="flex flex-col items-center justify-center py-8 gap-3">
            ...
            />
            <p className="font-signage text-[12px]" style={{ color: "#6B7D8E" }}>
