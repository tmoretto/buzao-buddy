        ...
        {MAPBOX_TOKEN ? (
          <div className="relative h-full w-full overflow-hidden" style={OPERATIONS_MAP_PANEL_STYLE}>
            ...
            <div className="pointer-events-none absolute left-3 top-3 flex items-center gap-2">
              ...
              <span className="font-signage rounded-md px-2 py-1 text-[11px]" style={{ backgroundColor: "rgba(8, 16, 23, 0.78)", color: "#6B7D8E", border: "1px solid rgba(255,255,255,0.08)" }}>
                cobertura 2km
              </span>
            </div>
          </div>
